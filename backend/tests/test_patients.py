...
@pytest.mark.unit
async def test_get_patient_by_user_id(mock_database, mock_patient_record):
    """Test retrieving patient by user ID."""
    mock_database.patients.find_one = AsyncMock(return_value=mock_patient_record)
...
@pytest.mark.unit
async def test_update_patient_success(mock_database, mock_patient_record):
...
@pytest.mark.unit
async def test_add_medical_history_success(mock_database, mock_patient_record):
...
@pytest.mark.unit
async def test_get_medical_history(mock_database, mock_patient_record):
...
@pytest.mark.unit
async def test_update_medical_history_success(mock_database, mock_patient_record):
...
@pytest.mark.unit
async def test_add_allergy_success(mock_database, mock_patient_record):
...
@pytest.mark.unit
async def test_get_allergies(mock_database, mock_patient_record):
...
@pytest.mark.unit
async def test_delete_allergy_success(mock_database, mock_patient_record):
...
@pytest.mark.unit
async def test_add_insurance_new(mock_database, mock_patient_record):
...
@pytest.mark.unit
async def test_add_insurance_update_existing(mock_database, mock_patient_record, mock_insurance_record):
    """Test updating existing insurance."""
    mock_database.patients.find_one = AsyncMock(return_value=mock_patient_record)
    mock_database.insurance.find_one = AsyncMock(return_value=mock_insurance_record)
...
@pytest.mark.unit
async def test_get_insurance(mock_database, mock_patient_record, mock_insurance_record):
...
@pytest.mark.unit
async def test_calculate_health_score(mock_database, mock_patient_record):
    ...
    result = await service.calculate_health_score("PT123", mock_patient_record)
...
async def test_get_medications_count(mock_database):
    ...
    assert count >= 0
    mock_database.medical_history.find.assert_called_once()
